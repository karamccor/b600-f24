...
```{r eval = F}
download.file("https://karamccor.github.io/b600-f24/labs/lab-01-template.Rmd", destfile="lab-00.Rmd")
```
...
- "Knit" the .Rmd file to an html file, by clicking on the blue knit button at the top of this window. 
